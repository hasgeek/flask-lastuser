...
sys.path.append(os.path.abspath('../flask_lastuser'))
...
man_pages = [
    ('index', 'flask-lastuser', u'flask-lastuser Documentation',
     [u'HasGeek'], 1)
]
...
texinfo_documents = [
  ('index', 'flask-lastuser', u'flask-lastuser Documentation',
   u'HasGeek', 'flask-lastuser', 'Flask extension for Lastuser',
   'Miscellaneous'),
]
